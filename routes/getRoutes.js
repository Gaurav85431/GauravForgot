...
get_route.post('/change-password/', auth, user_controller.resetpassword);
get_route.post('/logout'/*'/logout/:token'*/, auth, user_controller.logoutAllDevice);
get_route.post('/logoutOne', auth, user_controller.logout);
